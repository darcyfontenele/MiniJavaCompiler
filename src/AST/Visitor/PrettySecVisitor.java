...
public class PrettySecVisitor implements SecVisitor {
  ...
  public void visit(Assign n, Map mapa, int nivel, Classe cl, Metodo mt) {
    ...
    {
    	Variavel a = (Variavel)cl.variavel.get(n.i.s);
    	identifType = a.type;
    }else if(mt.arg.containsKey(n.i.s)){
    	Variavel a = (Variavel)mt.arg.get(n.i.s);
    	identifType = a.type;
    	
    }else if(mt.variavel.containsKey(n.i.s)){
    	Variavel a = (Variavel)mt.variavel.get(n.i.s);
    	identifType = a.type;
    }
    else if(cl.extendida != null)
    {
    	...
    	do{
    		if(mapa.containsKey(classPai))
    		{
    			...
    			{
    				Variavel a = (Variavel)exten.variavel.get(identif);
    				identifType = a.type;
    				break;
    			}
  ...
  public void visit(ArrayAssign n, Map mapa, int nivel, Classe cl, Metodo mt) {
	...
	{
		Variavel a = (Variavel)cl.variavel.get(identif);
		identifType = a.type;
	}
	else if(mt.arg.containsKey(identif))
	{
		Variavel a = (Variavel)mt.arg.get(identif);
		identifType = a.type;
	}
	else if(mt.variavel.containsKey(identif))
	{
		Variavel a = (Variavel)mt.variavel.get(identif);
		identifType = a.type;
	}
	else if(cl.extendida != null)////
	{
			...
			if(b != null)
			{
				...
				else
				{
					while(i2.hasNext())
					{
		            	...
		            	Variavel vari1 = (Variavel)entrada1.getValue();
	            ...
	            if(erroDeArgumento){
	            	...
	            	{
	            		Map.Entry entrada = (Map.Entry)ii.next();
		            	Variavel vari = (Variavel)entrada.getValue();
